...
Задает имя конкретной конфигурации пресета. Имя используется при сборе статистики трансформаций кода - смотри описание параметра [useStatsServer](#useStatsServer). Указание имени важно при сборе статистики по трансформациям.
